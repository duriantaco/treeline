...
<details><summary>▼ - *...and 605 more medium priority issues*</summary>
...
- **utils/report.py:120**: Function has too many parameters (7 > 5)
- **utils/report.py:138**: Function has too many parameters (7 > 5)
- **utils/report.py:35**: Function is too long (61 > 50 lines)
- **utils/report.py:346**: Function is too long (55 > 50 lines)
- **utils/report.py:586**: Function is too long (52 > 50 lines)
- **utils/report.py:640**: Function is too long (66 > 50 lines)
- **utils/report.py:708**: Function is too long (69 > 50 lines)
- **utils/report.py:846**: Function is too long (135 > 50 lines)
- **utils/report.py:35**: Function has deeply nested blocks (4 > 3 levels)
- **utils/report.py:120**: Function has deeply nested blocks (4 > 3 levels)
- **utils/report.py:138**: Function has deeply nested blocks (4 > 3 levels)
- **utils/report.py:192**: Function has deeply nested blocks (4 > 3 levels)
- **utils/report.py:220**: Function has deeply nested blocks (4 > 3 levels)
- **utils/report.py:244**: Function has deeply nested blocks (5 > 3 levels)
- **utils/report.py:284**: Function has deeply nested blocks (4 > 3 levels)
- **utils/report.py:346**: Function has deeply nested blocks (6 > 3 levels)
- **utils/report.py:708**: Function has deeply nested blocks (5 > 3 levels)
- **utils/report.py:284**: Function has too many return statements (5 > 4)
- **utils/report.py:244**: Function has too many branches (7 if statements)
- **utils/report.py:284**: Function has too many branches (5 if statements)
- **utils/report.py:346**: Function has too many branches (10 if statements)
- **utils/report.py:468**: Function has too many branches (9 if statements)
- **utils/report.py:708**: Function has too many branches (8 if statements)
- **utils/report.py:303**: Empty except block
- **utils/report.py:303**: Too broad exception handler (except Exception:)
- **utils/report.py:67**: Too broad exception handler (except Exception:)
...
- **utils/report.py:6**: High cyclomatic complexity (159 > 10) in class 'ReportGenerator'
- **utils/report.py:6**: High cognitive complexity (301 > 15) in class 'ReportGenerator'
- **utils/report.py:220**: High cognitive complexity (18 > 15) in function '_collect_complex_functions'
- **utils/report.py:244**: High cyclomatic complexity (18 > 10) in function '_build_structure_data'
- **utils/report.py:244**: High cognitive complexity (37 > 15) in function '_build_structure_data'
- **utils/report.py:284**: High cyclomatic complexity (11 > 10) in function '_module_to_file_path'
- **utils/report.py:284**: High cognitive complexity (16 > 15) in function '_module_to_file_path'
- **utils/report.py:346**: High cyclomatic complexity (24 > 10) in function '_build_script_info'
- **utils/report.py:346**: High cognitive complexity (53 > 15) in function '_build_script_info'
- **utils/report.py:468**: High cyclomatic complexity (14 > 10) in function '_generate_architectural_insights_subsection'
- **utils/report.py:468**: High cognitive complexity (17 > 15) in function '_generate_architectural_insights_subsection'
- **utils/report.py:708**: High cyclomatic complexity (13 > 10) in function '_generate_dependency_section'
- **utils/report.py:708**: High cognitive complexity (32 > 15) in function '_generate_dependency_section'
...
<details><summary>▼ - *...and 115 more low priority issues*</summary>
...
- **utils/report.py:None**: File has 1010 lines (over 1000)
- **utils/report.py:59**: Line is too long (135 > 120 chars)
- **utils/report.py:116**: Line is too long (125 > 120 chars)
- **utils/report.py:162**: Line is too long (191 > 120 chars)
- **utils/report.py:178**: Line is too long (131 > 120 chars)
- **utils/report.py:215**: Line is too long (122 > 120 chars)
- **utils/report.py:230**: Line is too long (143 > 120 chars)
- **utils/report.py:332**: Line is too long (142 > 120 chars)
- **utils/report.py:425**: Line is too long (163 > 120 chars)
- **utils/report.py:436**: Line is too long (181 > 120 chars)
- **utils/report.py:439**: Line is too long (125 > 120 chars)
- **utils/report.py:447**: Line is too long (152 > 120 chars)
- **utils/report.py:493**: Line is too long (122 > 120 chars)
- **utils/report.py:498**: Line is too long (138 > 120 chars)
- **utils/report.py:500**: Line is too long (124 > 120 chars)
- **utils/report.py:503**: Line is too long (143 > 120 chars)
- **utils/report.py:505**: Line is too long (131 > 120 chars)
- **utils/report.py:513**: Line is too long (134 > 120 chars)
- **utils/report.py:521**: Line is too long (153 > 120 chars)
- **utils/report.py:535**: Line is too long (155 > 120 chars)
- **utils/report.py:537**: Line is too long (162 > 120 chars)
- **utils/report.py:540**: Line is too long (159 > 120 chars)
- **utils/report.py:563**: Line is too long (175 > 120 chars)
- **utils/report.py:589**: Line is too long (156 > 120 chars)
- **utils/report.py:627**: Line is too long (123 > 120 chars)
- **utils/report.py:632**: Line is too long (122 > 120 chars)
- **utils/report.py:643**: Line is too long (171 > 120 chars)
- **utils/report.py:648**: Line is too long (215 > 120 chars)
- **utils/report.py:657**: Line is too long (190 > 120 chars)
- **utils/report.py:658**: Line is too long (136 > 120 chars)
- **utils/report.py:661**: Line is too long (219 > 120 chars)
- **utils/report.py:666**: Line is too long (153 > 120 chars)
- **utils/report.py:667**: Line is too long (126 > 120 chars)
- **utils/report.py:681**: Line is too long (136 > 120 chars)
- **utils/report.py:682**: Line is too long (136 > 120 chars)
- **utils/report.py:687**: Line is too long (180 > 120 chars)
- **utils/report.py:694**: Line is too long (140 > 120 chars)
- **utils/report.py:695**: Line is too long (140 > 120 chars)
- **utils/report.py:700**: Line is too long (184 > 120 chars)
- **utils/report.py:711**: Line is too long (283 > 120 chars)
- **utils/report.py:714**: Line is too long (138 > 120 chars)
- **utils/report.py:731**: Line is too long (146 > 120 chars)
- **utils/report.py:746**: Line is too long (146 > 120 chars)
- **utils/report.py:763**: Line is too long (141 > 120 chars)
- **utils/report.py:802**: Line is too long (241 > 120 chars)
- **utils/report.py:843**: Line is too long (134 > 120 chars)
- **utils/report.py:877**: Line is too long (133 > 120 chars)
- **utils/report.py:889**: Line is too long (177 > 120 chars)
- **utils/report.py:905**: Line is too long (155 > 120 chars)
- **utils/report.py:914**: Line is too long (122 > 120 chars)
- **utils/report.py:933**: Line is too long (122 > 120 chars)
- **utils/report.py:953**: Line is too long (150 > 120 chars)
- **utils/report.py:960**: Line is too long (126 > 120 chars)
- **utils/report.py:39**: Line has trailing whitespace
- **utils/report.py:41**: Line has trailing whitespace
- **utils/report.py:55**: Line has trailing whitespace
- **utils/report.py:105**: Line has trailing whitespace
- **utils/report.py:174**: Line has trailing whitespace
- **utils/report.py:196**: Line has trailing whitespace
- **utils/report.py:197**: Line has trailing whitespace
- **utils/report.py:330**: Line has trailing whitespace
- **utils/report.py:407**: Line has trailing whitespace
- **utils/report.py:474**: Line has trailing whitespace
- **utils/report.py:822**: Line has trailing whitespace
- **utils/report.py:856**: Line has trailing whitespace
- **utils/report.py:1010**: File does not end with a newline
...
<details><summary>▼ *...and 42 more complex functions*</summary>

| Module | Function | Cyclomatic Complexity | Cognitive Complexity | Lines | Parameters | Has Docstring |
|--------|----------|-----------------------|----------------------|-------|------------|---------------|
| checkers.unused_code | _check_name_usage | 14 | 0 | 26 | 3 | ❌ |
| utils.report | _generate_architectural_insights_subsection | 14 | 0 | 49 | 1 | ❌ |
| utils.report | _generate_dependency_section | 13 | 0 | 70 | 1 | ❌ |
...
| utils.report | analyze | 10 | 0 | 62 | 1 | ❌ |
| utils.report | _collect_complex_functions | 10 | 0 | 23 | 1 | ❌ |
...
| utils.report | _collect_function_dependencies | 8 | 0 | 27 | 1 | ❌ |
| utils.report | _generate_issues_section | 8 | 0 | 53 | 1 | ❌ |
...
| utils.report | _find_circular_path | 7 | 0 | 17 | 7 | ✅ |
| utils.report | _find_module_circular_path | 7 | 0 | 16 | 7 | ✅ |
| utils.report | _generate_impact_analysis_subsection | 7 | 0 | 23 | 1 | ❌ |
...
| utils.report | _generate_circular_dependency_section | 6 | 0 | 36 | 1 | ✅ |
</details>
...
<details><summary>▼ ...and 159 more functions</summary>
...
| utils | _build_script_info | ❌ | Add docstring |
...
| utils | _find_circular_path | ✅ | None |
| utils | _find_module_circular_path | ✅ | None |
| utils | _generate_architectural_insights_subsection | ❌ | Add docstring |
| utils | _generate_circular_dependency_section | ✅ | None |
| utils | _generate_complex_functions_section | ❌ | Add docstring |
| utils | _generate_config_section | ❌ | Add docstring |
| utils | _generate_connected_files_subsection | ❌ | Add docstring |
| utils | _generate_dependency_section | ❌ | Add docstring |
| utils | _generate_docstring_section | ❌ | Add docstring |
| utils | _generate_executive_summary | ❌ | Add docstring |
| utils | _generate_header_section | ❌ | Add docstring |
| utils | _generate_impact_analysis_subsection | ❌ | Add docstring |
| utils | _generate_issues_section | ❌ | Add docstring |
| utils | _generate_line_count_section | ❌ | Add docstring |
| utils | _generate_stability_analysis_subsection | ❌ | Add docstring |
| utils | _generate_structure_analysis_section | ❌ | Add docstring |
| utils | _module_to_file_path | ❌ | Add docstring |
| utils | _should_analyze_file | ❌ | Add docstring |
| utils | analyze | ❌ | Add docstring |
| utils | detect_circular_dependencies | ✅ | None |
